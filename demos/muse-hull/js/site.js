/* Muse. — shared site behaviour. No dependencies. */
(function () {
  ...
  /* On mobile, tapping "Services" opens the submenu instead of navigating;
  ...
  if (hdr) {
    ...
    var onScroll = function () {
      if (!ticking) {
        ticking = true;
        requestAnimationFrame(function () { hdr.classList.toggle('scrolled', window.scrollY > 30); ticking = false; });
      }
    };
